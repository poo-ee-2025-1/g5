...
{   Stage stage;
    ...
    */
    ...
    private void carregarEmpresasNoMenuButton() {
        ...
        listaEmpresas.add(new model.Empresa(3, "Empresa Ranys"));
    ...
    private boolean validarLogin(String email, String senha) {
        //exemplo
        return email.equals("admin@exemplo.com") && senha.equals("1234");
    ...
    public void gerarOrcamento(Event e){
        // vai pegar as informações enviadas pelo engenheiro e printa-las no campoDeTexto
        /* semelhante a esse codigo , ja usado aqui . :
         * 
         * 
         * private void carregarEmpresasNoMenuButton() {
        // Limpa quaisquer MenuItems existentes 
