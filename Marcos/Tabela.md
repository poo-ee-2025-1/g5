# Tabelas do Comparativo de Eficiência Energética (Versão Corrigida)
...
| **Classe de Eficiência** | **Padrão (IE2)** | Alta (IE3) |
...
| **Modelo Real** | Schulz Heavy Duty Pistão 15 kW | **Atlas Copco GA 15 VSD+** |
| Categoria | Compressor | Compressor |
| **Capacidade** | **20 HP (15 kW)** | **20 HP (15 kW)** |
| Tensão de Operação | 380 V | 380 V |
| Classe de Eficiência | Baixa | Alta |
| Setor Industrial | Automobilístico | Automobilístico |
| Sistema de Controle | Fixo | Inversor de frequência (VSD) |
...
| Atributo | Ineficiente | Eficiente |
| :--- | :--- | :--- |
| Nome | Ventilador Axial Comum | Ventilador com Motor EC |
| **Modelo Real** | Ventisilva VBI-5.0 | **Ventilador com Motor EC 1,5 kW** |
| Categoria | Ventilação | Ventilação |
| **Potência Nominal** | **2 HP (1,5 kW)** | **2 HP (1,5 kW)** |
| Tensão de Operação | 220 V | 220 V |
...
| **Capacidade** | **9.000 BTU** | **9.000 BTU** |
| Tensão de Operação | 220 V | 220 V |
...
Equipamento gastava *1000 kWh/mês* → passou a gastar *700 kWh/mês* Total economizado: *300 kWh/mês (30%)*
